  ...
  return (
    <>
      ...
      <LayoutTwoColumn pathname={location.pathname}>
            ...
            <div className={styles.contents_inner}>
              <div className={styles.text_area}>
                ...
                <div className={styles.text_wrapper}>
                  <TextMedium text="プロテクター（捕獲士）を志す１５歳の少年。主⼈公。" />
                  <TextMedium text="ウェイクライドの達⼈で勉強は苦⼿。ガーデンで⽣物の写真を撮る孤児達の夢＝新種⽣物の発⾒（ブルーの獲得）を、捕獲⼠として⾃分の⼿で叶えてやりたいと考えている。" />
                  <TextMedium text="10年前のヴァルハラ事故において、研究者である⽗親が⾏⽅不明となり、以来グラン・ムー第4都市オクタムにて⺟親と⼆⼈暮らし。いつか正式なブルーハンターとなり、都市間を移動しながら⽗親を捜索する、という夢がある。ハンターギルド「ψ」で研修中の見習い（カデット）だが、時に⼤⼈以上の能⼒を発揮し、皆を魅了していく。" />
                  <TextMedium text="⾜の裏に紋章のような⼿術跡がある。" />
                </div>
              </div>
              <div className={styles.img_area}>
                <img src="/characters/kakeru.png" alt="カケル" />
              </div>
            </div>
          </MainContentsMiddle>
          {/* --------------------------------------- mal様修正範囲 終了 --------------------------------------- */}
        ...
        <PagerAreaCharacters hrefPrev="/characters/nagisa/" hrefNext="/characters/viola/" isDisabledPrev={false} isDisabledNext={false} />
