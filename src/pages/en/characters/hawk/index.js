  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://manga.uminohi.jp/en/characters/hawk/" />
        <meta property="og:url" content="https://manga.uminohi.jp/en/characters/hawk/" />
        {/* --------------------------------------- mal様修正範囲(meta情報) 終了 --------------------------------------- */}
      ...
      <LayoutTwoColumn pathname={location.pathname}>
        ...
        {/* パンクズリスト */}
        <BreadShort page01="TOP" href01="/en" page02="Characters - Hawk" />
        <SliderCharacters pathname={location.pathname} />
        <ContentsInner>
          <MainContentsMiddle>
            <div className={styles.contents_inner}>
              <div className={styles.text_area}>
                <TextHeadingCharacters text="Hawk" />
                <div className={styles.lavel02_wrapper}>
                  <Label02 text="Operator" />
                </div>
                <div className={styles.text_wrapper}>
                  <TextMedium text="A 17-year-old highly-skilled Operator and Blue Hunter. He belongs to Savian, a powerful guild and rival to ψ (Psi). He is highly-respected and trusted by both the adults and children of Garden 3. His strength makes him a genius at handling UG." />
                  <TextMedium text="Lacking both legs since birth, Hawk's training in wheelchair basketball means he is able to perform agile and delicate work using his arms." />
                  <TextMedium text="He has spent a lot of time with Tsukito in the Garden, and as a result has taken it upon himself to fulfill Tsukito's dream." />
                </div>
              </div>
              <div className={styles.img_area}>
                <img src="/characters/hawk.png" alt="Hawk" />
              </div>
            </div>
          </MainContentsMiddle>
          {/* --------------------------------------- mal様修正範囲 終了 --------------------------------------- */}
        ...
        <PagerAreaCharacters hrefPrev="/en/characters/tsukito/" hrefNext="/en/characters/yoshinori/" isDisabledPrev={false} isDisabledNext={false} />
