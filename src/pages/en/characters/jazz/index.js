  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://manga.uminohi.jp/en/characters/jazz/" />
        <meta property="og:url" content="https://manga.uminohi.jp/en/characters/jazz/" />
        {/* --------------------------------------- mal様修正範囲(meta情報) 終了 --------------------------------------- */}
      ...
      <LayoutTwoColumn pathname={location.pathname}>
            ...
            <div className={styles.contents_inner}>
              <div className={styles.text_area}>
                ...
                <div className={styles.text_wrapper}>
                  <TextMedium text="The ace of ψ. Blessed with both brawn and high-level skills, he is well known for being the current best in the field." />
                </div>
              </div>
              <div className={styles.img_area}>
                <img src="/characters/jazz.png" alt="JAZz" />
              </div>
            </div>
          </MainContentsMiddle>
          {/* --------------------------------------- mal様修正範囲 終了 --------------------------------------- */}
        ...
        <PagerAreaCharacters hrefPrev="/en/characters/skull/" hrefNext="/en/characters/nagisa/" isDisabledPrev={false} isDisabledNext={false} />
