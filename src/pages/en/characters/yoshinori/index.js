  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://manga.uminohi.jp/en/characters/yoshinori/" />
        <meta property="og:url" content="https://manga.uminohi.jp/en/characters/yoshinori/" />
        {/* --------------------------------------- mal様修正範囲(meta情報) 終了 --------------------------------------- */}
      ...
      <LayoutTwoColumn pathname={location.pathname}>
        ...
        {/* パンクズリスト */}
        <BreadShort page01="TOP" href01="/" page02="Characters - Yoshinori Ourai" />
            ...
            <div className={styles.contents_inner}>
              <div className={styles.text_area}>
                ...
                <div className={styles.text_wrapper}>
                  <TextMedium text="Guild master overseeing ψ. Has an unyielding temperament and is known by the nickname Embodiment (All Right)" />
                </div>
              </div>
        ...
        <PagerAreaCharacters hrefPrev="/en/characters/hawk/" hrefNext="/en/characters/skull/" isDisabledPrev={false} isDisabledNext={false} />
