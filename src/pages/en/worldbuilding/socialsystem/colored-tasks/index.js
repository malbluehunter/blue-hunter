  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://manga.uminohi.jp/en/worldbuilding/socialsystem/colored-tasks/" />
        <meta property="og:url" content="https://manga.uminohi.jp/en/worldbuilding/socialsystem/colored-tasks/" />
        {/* --------------------------------------- mal様修正範囲(meta情報) 終了 --------------------------------------- */}
      ...
      <LayoutTwoColumn pathname={location.pathname}>
        ...
        {/* パンクズリスト */}
        <Bread page01="TOP" href01="/en/" page02="The World of BH" href02="/en/worldbuilding/" page03="Social System - Colored Tasks" />
        <div className={styles.contents_inner}>
          ...
          <PagerArea pathname={location.pathname} hrefPrev="/en/worldbuilding/socialsystem/fairchain/" hrefNext="/en/worldbuilding/socialsystem/rarity/" isDisabledPrev={false} isDisabledNext={false}  number={6} TotalNumber={8} />
      {/* --------------------------------------- mal様修正範囲 終了 --------------------------------------- */}
        </WorldContentsInner>
