  ...
  return (
    <>
      ...
      <LayoutTwoColumn pathname={location.pathname}>
        ...
        {/* パンクズリスト */}
        <Bread page01="TOP" href01="/en" page02="The World of BH" href02="../../index.html" page03="Background - 0. Background Knowledge: CCZ" />
...
"
          ...
          <PagerArea pathname={location.pathname} hrefPrev="" hrefNext="../marine-metropolitan-areas/" isDisabledPrev={true} isDisabledNext={false} number={1} TotalNumber={10} />
          {/* --------------------------------------- mal様修正範囲 終了 --------------------------------------- */}
        </WorldContentsInner>
