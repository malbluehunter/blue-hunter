    ...
    <>
      ...
      <LayoutTwoColumn pathname={location.pathname}>
        ...
        <div className={styles.contents_inner}>
          ...
          <PagerArea pathname={location.pathname} hrefPrev="/en/worldbuilding/background/octam4/" hrefNext="" isDisabledPrev={false} isDisabledNext={true}  number={10} TotalNumber={10} />
      {/* --------------------------------------- mal様修正範囲 終了 --------------------------------------- */}
        </WorldContentsInner>
