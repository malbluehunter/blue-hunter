  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://manga.uminohi.jp/en/worldbuilding/background/seaforce/" />
        <meta property="og:url" content="https://manga.uminohi.jp/en/worldbuilding/background/seaforce/" />
        {/* --------------------------------------- mal様修正範囲(meta情報) 終了 --------------------------------------- */}
      ...
      <LayoutTwoColumn pathname={location.pathname}>
        ...
        {/* パンクズリスト */}
        <Bread page01="TOP" href01="/en/" page02="The World of BH" href02="/en/worldbuilding/" page03="Background - Underwater Electrical Supply Towers (SeaForce)" />
        <div className={styles.contents_inner}>
          ...
          <PagerArea pathname={location.pathname} hrefPrev="/en/worldbuilding/background/octam3/" hrefNext="/en/worldbuilding/background/octam4/" isDisabledPrev={false} isDisabledNext={false}  number={9} TotalNumber={10} />
      {/* --------------------------------------- mal様修正範囲 終了 --------------------------------------- */}
        </WorldContentsInner>
