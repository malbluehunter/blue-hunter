  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://manga.uminohi.jp/en/comic/ep5/" />
        <meta property="og:url" content="https://manga.uminohi.jp/en/comic/ep5/" />
        {/* --------------------------------------- mal様修正範囲(meta情報) 終了 --------------------------------------- */}
          ...
          <div>
            ...
            <div className={styles.btn_wrapper}>
              ...
              {/* <div className={styles.btn_plan}>
                <Button isDisabled={true}>Next chapter out July 29</Button>
              </div> */}
            </div>
          </div>
        </ComicContentsInner>
