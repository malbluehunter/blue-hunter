  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://manga.uminohi.jp/worldbuilding/socialsystem/colored-tasks/" />
        <meta property="og:url" content="https://manga.uminohi.jp/worldbuilding/socialsystem/colored-tasks/" />
        {/* --------------------------------------- mal様修正範囲(meta情報) 終了 --------------------------------------- */}
      ...
      <LayoutTwoColumn pathname={location.pathname}>
        ...
        {/* パンクズリスト */}
        <Bread page01="TOP" href01="/" page02="世界観・設定" href02="/worldbuilding/" page03="社会制度 - カラータスク" />
        <div className={styles.contents_inner}>
          ...
          <PagerArea pathname={location.pathname} hrefPrev="/worldbuilding/socialsystem/fairchain/" hrefNext="/worldbuilding/socialsystem/rarity/" isDisabledPrev={false} isDisabledNext={false}  number={6} TotalNumber={8} />
      {/* --------------------------------------- mal様修正範囲 終了 --------------------------------------- */}
        </WorldContentsInner>
