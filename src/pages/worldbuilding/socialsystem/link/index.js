  ...
  return (
    <>
      ...
      <LayoutTwoColumn>
        ...
        {/* パンクズリスト */}
        <Bread page01="TOP" href01="/" page02="世界観・設定" href02="../../index.html" page03="社会制度 - Lk -リンク-" />
        <WorldContentsInner>
          ...
          <PagerArea hrefPrev="../tk/" hrefNext="../gains/" isDisabledPrev={false} isDisabledNext={false}  number={2} />
      {/* --------------------------------------- mal様修正範囲 終了 --------------------------------------- */}
        </WorldContentsInner>
      </LayoutTwoColumn>
    </>
