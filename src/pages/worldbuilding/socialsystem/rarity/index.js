  ...
  return (
    <>
      ...
      <LayoutTwoColumn pathname={location.pathname}>
        ...
        {/* パンクズリスト */}
        <Bread page01="TOP" href01="/" page02="世界観・設定" href02="/worldbuilding/" page03="社会制度 - Rrt -レアリティ-" />
        <div className={styles.contents_inner}>
          ...
          <MainContentsMiddleWorld pathname={location.pathname}>
            ...
            <div className={styles.textMediumSub_wrapper}>
              <TextMediumSub text="調整依頼。遺伝⼦（⾝体の⼀部分）などの物理的な⽣体情報や写真、⽬撃証⾔などを総合し、少なくとも過去に存在したと考えられる未発⾒⽣物群。ハンターたちが「未発⾒」「ターゲット」と呼ぶカード。正式名が与えられず、仮称で呼ばれることが多い。「6枚⽻」「針ウロコ」など。" />
            </div>
            <div className={styles.textLeading_wrapper}>
          ...
          <PagerArea pathname={location.pathname} hrefPrev="/worldbuilding/socialsystem/colored-tasks/" hrefNext="/worldbuilding/socialsystem/road-to-blue/" isDisabledPrev={false} isDisabledNext={false} number={7} TotalNumber={8} />
          {/* --------------------------------------- mal様修正範囲 終了 --------------------------------------- */}
        </WorldContentsInner>
