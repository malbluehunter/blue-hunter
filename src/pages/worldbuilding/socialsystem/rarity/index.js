  ...
  return (
    <>
      ...
      <LayoutTwoColumn pathname={location.pathname}>
        ...
        {/* パンクズリスト */}
        <Bread page01="TOP" href01="/" page02="世界観・設定" href02="../../index.html" page03="社会制度 - Rrt -レアリティ-" />
        <WorldContentsInner>
          ...
          <PagerArea hrefPrev="../colored-tasks/" hrefNext="../road-to-blue/" isDisabledPrev={false} isDisabledNext={false} number={7} TotalNumber={10} />
          {/* --------------------------------------- mal様修正範囲 終了 --------------------------------------- */}
        </WorldContentsInner>
      </LayoutTwoColumn>
    </>
