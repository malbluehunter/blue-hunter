    ...
    <>
      ...
      <LayoutTwoColumn pathname={location.pathname}>
        ...
        <div className={styles.contents_inner}>
          ...
          <PagerArea pathname={location.pathname} hrefPrev="/worldbuilding/background/octam3/" hrefNext="/worldbuilding/background/seaforce/" isDisabledPrev={false} isDisabledNext={false}  number={9} TotalNumber={10} />
      {/* --------------------------------------- mal様修正範囲 終了 --------------------------------------- */}
        </WorldContentsInner>
