  ...
  return (
    <>
      ...
      <LayoutTwoColumn pathname={location.pathname}>
        ...
        {/* パンクズリスト */}
        <Bread page01="TOP" href01="/" page02="世界観・設定" href02="/worldbuilding/" page03="物語の背景 - 1.海洋都市圏の誕生" />
        <div className={styles.contents_inner}>
          <WorldContentsInner>
            ...
            <PagerArea pathname={location.pathname} hrefPrev="/worldbuilding/background/ccz/" hrefNext="/worldbuilding/background/grandmw/" isDisabledPrev={false} isDisabledNext={false} number={2} TotalNumber={10} />
            {/* --------------------------------------- mal様修正範囲 終了 --------------------------------------- */}
          </WorldContentsInner>
