  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://manga.uminohi.jp/worldbuilding/background/seaforce/" />
        <meta property="og:url" content="https://manga.uminohi.jp/worldbuilding/background/seaforce/" />
        {/* --------------------------------------- mal様修正範囲(meta情報) 終了 --------------------------------------- */}
      ...
      <LayoutTwoColumn pathname={location.pathname}>
        ...
        {/* パンクズリスト */}
        <Bread page01="TOP" href01="/" page02="世界観・設定" href02="/worldbuilding/" page03="物語の背景 - 海中発送電塔(シーフォース)" />
        <div className={styles.contents_inner}>
          ...
          <PagerArea pathname={location.pathname} hrefPrev="/worldbuilding/background/octam4/" hrefNext="" isDisabledPrev={false} isDisabledNext={true}  number={10} TotalNumber={10} />
      {/* --------------------------------------- mal様修正範囲 終了 --------------------------------------- */}
        </WorldContentsInner>
