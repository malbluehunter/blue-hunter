  ...
  return (
    <>
      ...
      <LayoutTwoColumn>
        ...
        {/* パンクズリスト */}
        <Bread page01="TOP" href01="/" page02="世界観・設定" href02="../../index.html" page03="物語の背景 - 海中発送電塔(シーフォース)" />
        <WorldContentsInner>
          ...
          <PagerArea hrefPrev="../octam3/" hrefNext="../octam4/" isDisabledPrev={false} isDisabledNext={false}  number={9} />
      {/* --------------------------------------- mal様修正範囲 終了 --------------------------------------- */}
        </WorldContentsInner>
      </LayoutTwoColumn>
    </>
