    ...
    <>
      ...
      <LayoutTwoColumn pathname={location.pathname}>
        ...
        <div className={styles.contents_inner}>
          ...
          <PagerArea pathname={location.pathname} hrefPrev="/worldbuilding/background/octam2/" hrefNext="/worldbuilding/background/octam4/" isDisabledPrev={false} isDisabledNext={false}  number={8} TotalNumber={10} />
      {/* --------------------------------------- mal様修正範囲 終了 --------------------------------------- */}
        </WorldContentsInner>
