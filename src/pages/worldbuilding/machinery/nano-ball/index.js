  ...
  return (
    <>
      ...
      <LayoutTwoColumn pathname={location.pathname}>
        ...
        {/* パンクズリスト */}
        <Bread page01="TOP" href01="/" page02="世界観・設定" href02="../../index.html" page03="メカ・アイテム - -ナノボール-" />
        <WorldContentsInner>
          ...
          <PagerArea hrefPrev="../bounty-kit/" hrefNext="../netbow/" isDisabledPrev={false} isDisabledNext={false}  number={4} TotalNumber={10} />
      {/* --------------------------------------- mal様修正範囲 終了 --------------------------------------- */}
        </WorldContentsInner>
      </LayoutTwoColumn>
    </>
