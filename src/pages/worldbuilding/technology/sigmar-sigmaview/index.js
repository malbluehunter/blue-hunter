  ...
  return (
    <>
      ...
      <LayoutTwoColumn pathname={location.pathname}>
        ...
        {/* パンクズリスト */}
        <Bread page01="TOP" href01="/" page02="世界観・設定" href02="../../index.html" page03="テクノロジー - ΣＲ(シグマアール)/ΣV(シグマビュー)" />
        <WorldContentsInner>
          ...
          <PagerArea hrefPrev="" hrefNext="../ug/" isDisabledPrev={true} isDisabledNext={false} number={1} TotalNumber={10} />
          {/* --------------------------------------- mal様修正範囲 終了 --------------------------------------- */}
        </WorldContentsInner>
      </LayoutTwoColumn>
    </>
