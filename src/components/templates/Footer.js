      ...
      <div className={styles.footer_area}>
        <div className={styles.footer_inner}>
          ...
          <ul className={styles.bnr_list}>
            ...
            <li className={styles.bnr_item}>
              <a href="https://world-eggs.jp/" target="_blank" rel="noopener">
                <picture>
            ...
            <li className={styles.bnr_item}>
              <a href="https://cannajapan.co.jp/" target="_blank" rel="noopener">
                <picture>
            ...
            <li className={styles.bnr_item}>
              <a href="https://myanimelist.net/" target="_blank" rel="noopener">
                <picture>
