      ...
      <div className={styles.mainVisual_area_inner}>
        <div className={styles.main_contents_area}>
          ...
          <div className={styles.news_wrapper}>
            <Link className={styles.news_text_wrapper} to="/en/comic/ep13/">
              <p className={styles.news_date}>March 29, 2022</p>
              <p className={styles.news_text}>Chapter 13 of the BLUE HUNTER manga now available!</p>
            </Link>
            <Link className={styles.news_btn} to="/en/comic/ep13/">
              <picture>
