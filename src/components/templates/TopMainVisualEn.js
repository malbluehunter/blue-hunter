      ...
      <div className={styles.mainVisual_area_inner}>
        <div className={styles.main_contents_area}>
          ...
          <div className={styles.news_wrapper}>
            <Link className={styles.news_text_wrapper} to="/en/comic/ep4/">
              <p className={styles.news_date}>July 16, 2021</p>
              <p className={styles.news_text}>Chapter 4 of the BLUE HUNTER manga now available!</p>
            </Link>
            <Link className={styles.news_btn} to="/en/comic/ep4/">
              <picture>
