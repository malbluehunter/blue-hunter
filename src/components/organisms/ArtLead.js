    ...
    <div className={styles.lead_area}>
      <div className={styles.lead_inner}>
        ...
        <div className={styles.lead_textBlock}>
          ...
          <p className={styles.lead_text}>全世界で70万人超が熱狂するWebtoon(縦読みマンガ)作品『BLUE HUNTER』を中心に<br />
          ”海洋の未来”をテーマにした物語・世界観を多言語、多メディアで展開。</p>
          <p className={styles.lead_text}>世界観に共鳴する世界中のBLUE HUNTERファンから、<br />
          アートコンペティションを通じて、現実の科学技術を牽引するような独創的な発想(空想)を募集。<br />
          海洋の専門家を中心とした審査チームが「発想の何が独創的なのか？」<br />
          「実現可能性と実現した際の海洋未来へのインパクト」を真剣に検討し、<br />
          トークセッションと共にアワード形式のイベントを行い、全世界へ発信。</p>
          <p className={styles.lead_text}>発想(空想)の力で『BLUE HUNTER』の世界を拡張し人々の関心を高め、<br />
