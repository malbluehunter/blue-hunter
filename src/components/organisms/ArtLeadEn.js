    ...
    <div className={styles.lead_area}>
      <div className={styles.lead_inner}>
        ...
        <div className={styles.lead_textBlock}>
          ...
          <p className={styles.lead_text}>With over 700,000 fans worldwide, BLUE HUNTER is a webtoon focused on “the future of the ocean” that has been published in multiple languages and media formats.</p>
